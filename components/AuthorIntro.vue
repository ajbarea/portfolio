<template>
    <div class="mb-6">
        ...
        <p class="mt-6 mb-4 dark:bg-gray-800 dark:text-blue-200 text-justify"> Welcome! This portfolio is a window into
            ...
            passions. <br /><br /> I've leveraged a powerful and growing tech stack to bring my projects to life: </p>
    </div>
</template>